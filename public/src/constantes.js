...
const gaccel3 = 2; // Posiciones en x que se mueven en el estante3
...
const estante1 = 550; //Posición y del estante1
const estante2 = 690; //Posición y del estante2
const estante3 = 830; //Posición y del estante3
const estante4 = 650; //Posición y del estante1
