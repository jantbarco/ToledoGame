...
function preloadD()
{
    this.load.image('sky', './assets/inicio/Fondo.jpg');
...
function createD()
{
    ...
    this.add.text(gw * .44, 350, 'Lograste', { font: 'bold 40px FontFabric', fill: '#ffffff' });
    this.add.text(gw * .46, 500, productos + ' pts', { font: 'bold 40px FontFabric', fill: '#ffffff' });
